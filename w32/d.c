...
ZI c0,c1,c4,c101,c102=SQL_AUTOCOMMIT_ON,c103,c108=SQL_TXN_SERIALIZABLE;//104 SQL_OPT_TRACE SQL_OPT_TRACEFILE SQL_TRANSLATE_DLL SQL_TRANSLATE_OPTION 109 SQL_CURRENT_QUALIFIER SQL_ODBC_CURSORS SQL_QUIET_MODE SQL_PACKET_SIZE
...
A SQLGetConnectAttr(D h,SQLINTEGER i,V*s,SQLINTEGER n,SQLINTEGER*i1){I v;SW(i){CD:R S1;//Q1("get")if(i!=30002)B("getconnectattr",i);
 CS(SQL_QUERY_TIMEOUT,v=c0)CS(SQL_MAX_ROWS,v=c1)CS(SQL_ASYNC_ENABLE,v=c4)CS(SQL_ATTR_ACCESS_MODE,v=c101)CS(SQL_CURRENT_QUALIFIER,*i1=v=0)
...
CS(SQL_ACCESSIBLE_PROCEDURES,s="N")
 ...
 CS(SQL_DRIVER_NAME,s="qodbc.dll")CS(SQL_DRIVER_ODBC_VER,s="02.51") //03.00=> descriptors sql_type_date etc.
