...
/ x from normal  (100terms for 1e-6 in 2 stddev's [.02 .98])
xn:{sqrt[2]*x$prds y,99#y*y:-1+2*y}{xexp[.5*sqrt pi;n]*x%n:1+2*til count x:x{x,sum(x*reverse x)%sums 1+4*til count x}/1.0}99
