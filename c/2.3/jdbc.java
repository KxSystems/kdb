...
public class co implements Connection{private c c;public co(String s,Object u,Object p)throws SQLException{int i=s.indexOf(":");
 ...
 public void close()throws SQLException{try{c.close();}catch(IOException e){q(e);}}
...
public class ps extends st implements PreparedStatement{private String s;public ps(co co,String x){super(co);s=x;}
 ...
 public void setObject(int i,Object x)throws SQLException{int n=c.n(p);if(i>n){
  Object[]r=new Object[i];System.arraycopy(p,0,r,0,n);p=r;for(;n<i;)p[n++]=null;}p[i-1]=x;}
...
public class rs implements ResultSet{private String[]f;private Object o,d[];private int r,n;
 ...
 public Object getObject(int i)throws SQLException{return o=c.at(d[i-1],r);}
...
public int getRow()throws SQLException{return r;}
public boolean absolute(int row)throws SQLException{r=row;return r<n;}
