...
public class c {
    public static void main(String[]args) { //s.setSoTimeout(ms);
    ...
    public static class Time {
        ...
        public String toString() {
            return new Second(i/1000).toString()+'.'+new DecimalFormat("000").format(i%1000);
        }
    }
    public static class Date {
        ...
        public Date(long x) {
            i=(int)(x/86400000)-10957;
        }
        public Date(java.util.Date d) {
            this(d.getTime());
        }
        public String toString() {
            return f.format(new java.util.Date(86400000L*(i+10957)));
        }
    }
    ...
    static{f.setTimeZone(java.util.TimeZone.getTimeZone("GMT"));
    }
}
